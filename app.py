...
st.set_page_config(page_title="Dr.BigBot", page_icon=":elephant:", layout="wide")

image1 = Image.open("Images/meal.png")
image2 = Image.open("Images/smoke.png")
image3 = Image.open("Images/ex.png")
image4 = Image.open("Images/ex1.png")
image5 = Image.open("Images/drink.png")
image6 = Image.open("Images/vit.png")
image7 = Image.open("Images/sm.png")
image8 = Image.open("Images/hf.png")
image9 = Image.open("Images/m.png")
image10 = Image.open("Images/stress.png")
image11 = Image.open("Images/co.png")
...
def main():
    ...
    set_png_as_page_bg('Images/d1.png')
    ...
    st.sidebar.title('Dr.BigBot SmartCare System')
    ...
    if choice == 'Login':
        ...
        if login:
            ...
            if bio == 'Settings':  
                set_png_as_page_bg('Images/h6.png')
                ...
                with exp2:   
                        ...
                        h2 = st.slider("Select Your Resting Blood Pressure (mm Hg):",0,150)
                        
                        s2 = st.selectbox("Chest Pain During Exercise:",("Yes","No"))
                        if s2=="Yes":
                           h4=1
                        else:
                           h4=0                        
                        ...
                        p4 = st.slider("Enter Your Breath Count Per Minute:",0,50)
                        ...
                        c2 = st.slider("Enter Your Glucose Level (mg/dL):",0,250)
                        
                        c3 = st.slider("Enter Your Blood Pressure (mmHg):",0,150)                      
                        ...
                        st.write("---")
                        st.subheader("To Identify Heart Failure Severity By Yourself...")
                        
                        k1 = st.slider("Enter Your Age Category (Ex: 50 to 59 = 5):",0,10)
                        
                        k3 =st.number_input("Enter Your Body Temperature (℃):")
                        
                        s2=st.selectbox("Do You Have Previous Heart Failure:",("Yes","No"))
                        if s2=="Yes":
                            k9=1
                        else:
                            k9=0 
     ...
     # HOME PAGE
                ...
                set_png_as_page_bg('Images/bk.png')    
                with st.container():
     ...
     # Recomandation PAGE
                ...
                with st.container():
                        ...
                        with left_column:
                            st.subheader("2.Control Conditions")
                            st.markdown(":man:")
                            st.write("##")
                            st.write(
                                """
                ...
                with st.container():
                        ...
                        with left_column:
                            st.subheader("3.Do physical activities")
                            st.markdown(":running:")
                            st.write("##")
                            st.write(
                                """
                ...
                with st.container():
                        ...
                        with left_column:
                            st.subheader("4.Have Healthy Food")
                            st.markdown(":apple:")
                            st.write("##")
                            st.write(
                                """
                ...
                with st.container():
                        ...
                        with left_column:
                            st.subheader("5.Maintain Weight")
                ...
                with st.container():
                        ...
                        with left_column:
                            st.subheader("6.Reducing and managing stress")
                            st.markdown(":smile:")
                            st.write("##")
                            st.write(
                                """
                            ...
                            - By doing exercises, relaxing the muscles, deep breathing will help you to run away from stress.
                                    """
                        )
                ...
                with st.container():
                        ...
                        with left_column:
                            st.subheader("1.Maintain a meal plan")
                            st.markdown(":apple:")
                            st.write("##")
                            st.write(
                                """
                ...
                with st.container():
                        ...
                        with left_column:
                            st.subheader("2.Daily Exercises")
                            st.markdown(":running:")
                            st.write("##")
                            st.write(
                                """
                            ...
                            st.write(
                                """
                                Follow below exercises to normalize your blood sugar.
                                """
                        )
                            st.write("[Watch the video >](https://www.youtube.com/watch?v=CGAV5Jo1EHk)")
                ...
                with st.container():
                        ...
                        with left_column:
                            st.subheader("5.Optimize your vitamin D levels")
                            st.markdown(":tomato:")
                            st.write("##")
                            st.write(
                                """
